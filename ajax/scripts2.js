\'g\');$.b({a:\'A\',q:s.t+\'/b/B-1M-1m.u\',C:\'2=\'+2+\'&U=\'+a,v:4(h){$(\'#7-8\').c(\'g\');D(h.E(0)){d\'0\':$(\'#1o\'+2).F(\'g\');6.m(\'n\',h.i(3));e;d\'1\':$(\'#1N\'+2).F(\'g\').w(h.i(3));e}},x:4(){$(\'#7-8\').c(\'5\');6.y("l.1n(\'"+2+"\',\'"+a+"\')");f}})},1p:4(2,a){6.S(T);6.1O(\'1P...\',\'1Q...\');$.b({a:\'A\',q:s.t+\'/b/B-1R-1S.u\',C:\'2=\'+2+\'&U=\'+a,v:4(h){6.1T();D(h.E(0)){d\'0\':6.m(\'n\',h.i(3));e;d\'1\':6.m(\'1U 1V 1W 1X 1Y!\',h.i(3),1q,1Z);e}},x:4(){6.y("l.1p(\'"+2+"\',\'"+a+"\')");f}})},1r:4(2,N){$(\'#7-8\').j(\'5\');$.b({a:\'20\',q:s.t+\'/b/21-B-22.u?23=\'+2+\'&N=\'+N,24:1q,v:4(h){$(\'#1s\').w(h);$(\'#1s\').j(\'5\');$(\'#7-8\').c(\'5\');$(\'#R\').G(25)},x:4(){$(\'#7-8\').c(\'5\');6.y("l.1r(\'"+2+"\',\'"+N+"\')");f},})}}',62,130,'||id||function|slow|dialogBox|vp|loading|disabled|type|ajax|slideUp|case|break|return|fast||substring|slideDown|val|muros|alert|Error|comment_muro|button_add_comment|url||urls|home|php|success|html|error|error_500|if|POST|wall|data|switch|charAt|fadeIn|fadeOut|removeAttr|removeClass|sub_comment_muro_|focus|comentario|perfil|action|else|own|last_update|return_agregar_muro|buttons|true|tipo|add_comment|Actualiza|tu|estado|Escribir|en|su|muro|msg_add_muro|hide|attr|addClass|comment|encodeURIComponent|cantmuro|sin_comments_muro|add_sub_comment|Escribe|un|return_sub_comentar_muro_|del_sub_comment|css|display|none|del_comment|i_like|i_like_txt_|like|i_dont_like|i_dont_like_txt_|ver_likes|false|filter_wall|ult_comm_muro|var|desplegar_comentador|islogged|Debes|est|aacute|logueado|comentador_|id_perfil|parseInt|msg_add_sub_muro|addsubcomment|del|subcomment|msg_del_muro_|sub_comentario_|delcomment|muro_|return_likes_|dont|return_i_dont_like_|procesando_inicio|Cargando|Solicitando|show|likes|procesando_fin|Personas|que|les|gusta|esto|450|GET|profile|filter|id_user|cache|500'.split('|'),0,{}));
/* web general */
...
function error_avatar(obj){
	obj.src = urls.images+'/avatar.gif';
}
		...
		if (!Hovercard.cache[uid]) {
			...
			if (!Hovercard.lock[uid]) {
				...
				$.ajax({
					...
					data: 'uid=' + uid,
					beforeSend: function() { template = '<div class="hovercard-' + uid + ' tooltip-c"><div id="ajax_loading" align="center"> <img src="/media/images/loading.gif" border="0" alt="Cargando..." title="Cargando..." /></div></div>'; },
					success: function (r) {
						template = $('#ajax_loading').toggle(500).fadeOut();
						if(r.charAt(0) == 1) {
...
bbcode = {
  VoopeWSet: [
      ...
      {name:'Tama&ntilde;o', dropMenu :[
          ...
          {name:'Gande', openWith:'[size=16px]', closeWith:'[/size]' },
...
var live = {
	updateTitle: function(num) {
		if(typeof this.titleOriginal === 'undefined') {
			this.titleOriginal = document.title;
		}
		var num = parseInt(num);
		document.title = (num > 0 ? '(' + num +') ' : '') + this.titleOriginal;
	},
	update: function() {
		$.ajax({
			...
			success: function(t) {
				...
				live.updateTitle((parseInt(t.notifications) + parseInt(t.messages)));
				if(t.notifications > 0 && t.notifications != parseInt($('#noti_box_not').html())) {
					$('#noti_box_not').fadeIn(500).html(t.notifications);
				}
				if(t.messages > 0 && t.messages != parseInt($('#noti_box_mp').html())) {
					$('#noti_box_mp').hide().html(t.messages);
				}
			}
		});
	},
