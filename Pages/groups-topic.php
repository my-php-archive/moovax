...
<td valign="top"><a href="/perfil/<?=$author['nick'];?>" title="<?=$author['nick'];?>" alt="<?=$author['nick'];?>"><img src="<?=$author['avatar'];?>" width="100px" height="100px" alt="<?=$author['nick'];?>" class="avatar" title="<?=$author['nick'];?>" onerror="error_avatar(this)" /></a></td>
...
<br>
<br class="space">
<a href="/rss/temas-comment/<?=$row['id'];?>"><span class="icons rss"></span></a> <b style="font-size:14px;"> Respuestas (<span id="cantcomments"><?=mysql_num_rows(mysql_query('SELECT `id` FROM `groups_comments` WHERE `id_topic` = \''.$row['id'].'\''));?></span>)</b><div class="barra-dashed"></div>
...
<br class="space">
<div class="floatR">
<div id="emoticons" style="float:left"><a href="#" smile=":bueno:"><img height="24" width="24" border="0" onclick="insertText(' :bueno:', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/bueno.png" alt="Bueno" title="Bueno"></a><a href="#" smile=":malo:"><img height="24" width="24" border="0" onclick="insertText(' :malo:', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/malo.png" alt="Malo" title="Malo"></a><a href="#" smile=":muerto:"><img height="24" width="24" border="0" onclick="insertText(' :muerto:', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/muerto.png" alt="Muerto" title="Muerto"></a><a href="#" smile=":divertido:"><img height="24" width="24" border="0" onclick="insertText(' :divertido:', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/divertido.png" alt="Divertido" title="Divertido"></a><a href="#" smile=":sinister:"><img height="24" width="24" border="0" onclick="insertText(' :sinister:', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/sinister.png" alt="Siniestro" title="Siniestro"></a><a href="#" smile=":D"><img height="24" width="24" border="0" onclick="insertText(' :D', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/sonrisa.png" alt="Sonrisa" title="Sonrisa"></a><a href="#" smile=":arrogante:"><img height="24" width="24" border="0" onclick="insertText(' :arrogante:', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/arrogante.png" alt="Arrogante" title="Arrogante"></a><a href="#" smile=":@"><img height="24" width="24" border="0" onclick="insertText(' :@', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/enojado.png" alt="Enojado" title="Enojado"></a><a href="#" smile=":relax:"><img height="24" width="24" border="0" onclick="insertText(' :relax:', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/relax.png" alt="Relajado" title="Relajado"></a><a href="#" smile=":ironico:"><img height="24" width="24" border="0" onclick="insertText(' :ironico:', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/ironico.png" alt="Ironico" title="Ironico"></a><a href="#" smile=":confused:"><img height="24" width="24" border="0" onclick="insertText(' :confused:', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/confused.png" alt="Confundido" title="Confundido"></a><a href="#" smile=":shamed:"><img height="24" width="24" border="0" onclick="insertText(' :shamed:', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/shamed.png" alt="Vergonzoso" title="Vergonzoso"></a><a href="#" smile=":disdain:"><img height="24" width="24" border="0" onclick="insertText(' :disdain:', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/disdain.png" alt="Disdain" title="Disdain"></a><a href="#" smile=":("><img height="24" width="24" border="0" onclick="insertText(' :(', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/triste.png" alt="Triste" title="Triste"></a><a href="#" smile=":sarcastico:"><img height="24" width="24" border="0" onclick="insertText(' :sarcastico:', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/sarcastico.png" alt="Sarcastico" title="Sarcastico"></a><a href="#" smile=":-)"><img height="24" width="24" border="0" onclick="insertText(' :-)', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/feliz.png" alt="Feliz" title="Feliz"></a><a href="#" smile=":lost:"><img height="24" width="24" border="0" onclick="insertText(' :lost:', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/lost.png" alt="Perdido" title="Perdido"></a><a href="#" smile=":shock:"><img height="24" width="24" border="0" onclick="insertText(' :shock:', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/shock.png" alt="Shock" title="Shock"></a><a href="#" smile=":llorar:"><img height="24" width="24" border="0" onclick="insertText(' :llorar:', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/llorar.png" alt="Llorando" title="Llorando"></a><a href="#" smile=":pirata:"><img height="24" width="24" border="0" onclick="insertText(' :pirata:', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/pirata.png" alt="Pirata" title="Pirata"></a><a href="#" smile=":devil:"><img height="24" width="24" border="0" onclick="insertText(' :devil:', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/devil.png" alt="Diablo" title="Diablo"></a><a href="#" smile=":loser:"><img height="24" width="24" border="0" onclick="insertText(' :loser:', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/loser.png" alt="Perdedor" title="Perdedor"></a><a href="#" smile=":ask:"><img height="24" width="24" border="0" onclick="insertText(' :ask:', document.forms.mensajero.VPeditor);" src="<?=$config['images'];?>/images/emoticons/ask.png" alt="Pregunta" title="Pregunta"></a></div>
